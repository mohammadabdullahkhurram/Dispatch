      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              This is permanent. All of this client&apos;s tickets, chat
              history, checklist items, documents, and portal user links will
              be deleted with them. There is no undo.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            <div className="space-y-1.5">
              <p className="text-sm text-muted-foreground">
                Type <span className="font-semibold text-foreground">{companyName}</span>{" "}
                to confirm.
              </p>
              <Input
                value={confirmText}
